...
<ol>
 <li>Active Azure Subscription: Ensure your Azure account is set up to create and manage Virtual Machines. </li>
  ...
  <li>osTicket Installation Package: Download the osTicket zip file from the[osTicket Official Website](https://osticket.com/download)
, extract it to the web root, and set necessary file permissions.   </li>
</ol>
